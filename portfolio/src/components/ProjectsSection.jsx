...
const projects = [
    {
        ...
        externalUrl: "https://play.google.com/store/apps/details?id=com.pariwar.pariwaragro&pcampaignid=web_share",
    },
    {
        id: 2,
        ...
        externalUrl: "https://www.linkedin.com/posts/hiteshpatil2005_edumarks-php-mysql-activity-7331337947012624386-l8fw?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEYpP8cBEx3HTi18qHpS3g8Dafn6tZkMBhs",
    },
    {
        id: 3,
        title: "AI based Smart Shopping Assistant",
        description: "AI-powered shopping assistant helps users find products, compare prices, and get personalized recommendations based on their preferences and shopping history.",
            ...
            <div className="container mx-auto max-w-9xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {projects.map((project, key) => (
                        <div key={key} className="glow-card group bg-card rounded-lg shadow-xs overflow-hidden card-hover" onMouseMove={handleMouseMove}>
                            {/* Glow layer */}
                            <div
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {project.tags.map((tag) => (
                                        <span key={tag} className="text-xs text-primary border-purple-400 bg-purple-300/15 border px-4 py-1 rounded-full">
                                            {tag}
                                        </span>
                                    ))}
                                </div>
                                <div className="flex justify-between items-center">
                                    <div className="flex space-x-3 p-3">
                                        <a href={project.githubUrl}
                                            ...
                                            <GithubOriginal size={30} style={{ filter: "brightness(0) saturate(100%) invert(57%) sepia(89%) saturate(5000%) hue-rotate(240deg)" }} />
                                        </a>
                                    </div>
                                    <div className="flex space-x-3 p-3">
                                        <a href={project.externalUrl} target="_blank" className="bg-linear-to-bl from-purple-400 to-purple-600 rounded-xl px-3 py-2 flex items-center gap-2">
                                            View Project
